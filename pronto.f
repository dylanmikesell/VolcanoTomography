...
cc                                                                    cc
cc                  Program: PRONTO                                   cc 
cc                  Programmer:  D.F. Aldridge                        cc
cc                  Last Revision Date:  22 December 2003             cc
cc                                                                    cc
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
cc
...
c
      if (iop_vin.eq.2) then
          ...
          if (v.le.0.0) then
              write (6,9003) x,z,v
 9003         format (/,6x,'Invalid velocity in input initial ',
     &                'model!',6x,'x = ',f8.3,6x,'z = ',f8.3,6x,
     &                'v = ',f8.3)
              stop
          endif
   ...
   30     s(i,j)=1.0/v 
          ...
          write (6,9004)
 9004     format (/,6x,'Initial slowness model obtained from external',
     &           ' file.')
